...
/* package HaskellVA-0.1.0.0 */
#ifndef VERSION_HaskellVA
#define VERSION_HaskellVA "0.1.0.0"
#endif /* VERSION_HaskellVA */
#ifndef MIN_VERSION_HaskellVA
#define MIN_VERSION_HaskellVA(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_HaskellVA */
...
#define CURRENT_COMPONENT_ID "HaskellVA-0.1.0.0-inplace-HaskellVA"
